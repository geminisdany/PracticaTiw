...
<body>
	...
	<!-- CONTENIDO QUE DEBERÃA CAMBIAR: todo el div de "main-content". action="Login"  servletn form falta implementacion--> 
	<div id="main-content">
	...
	<div class="site-footer">
		...
		<div class="bottom-footer">
			<div class="container-fluid">
				<div class="row">
					<div class="col-xs-6">
						<p class="copyright">Copyright © 2014 <a href="#">Talaverámica</a>
                        </p>
					</div>
