...
<body>
	...
	<div class="responsive-navigation visible-sm visible-xs">
		...
		<div class="user-menu-small row">
			<ul>
				<li class="user-register-small"><a
					href="cliente-registroUsuario.jsp" class="col-xs-6">Registrarse</a></li>
				<li class="user-login-small"><a href="cliente-login.jsp"
					class="col-xs-6">Entrar</a></li>
			</ul>
		</div>
		<div class="cesta-compra-small row">
			<a href="gestionCompra.jsp" class="col-xs-12">Cesta de la compra
				<img src="images/carritoCompra.png" alt="Carrito Compra" width="27"
				height="27">
			</a>
		</div>
	...
	<div id="topbar" class="hidden-xs hidden-sm">
		...
		<div class="user-menu">
			<ul>
				<li class="user-register"><a href="cliente-registroUsuario.jsp"
					class="col-xs-3">Registrarse</a></li>
				<li class="user-login"><a href="cliente-login.jsp"
					class="col-xs-3">Entrar</a></li>
			</ul>
		</div>
