	...
	public SimulacionBD() {
		...
		dbPedido.add(new Pedido(0, 4,"Botella amarilla", 4, 18.0));
		 ...
		 this.dbProductos = new ArrayList<Producto>();
	        dbProductos.add(new Producto(1, "A0001N", 25, 31, "fuente", "Fuente azul perfecta para diferentes snacks.", 55, "Fuente azul","http://media-cache-ec0.pinimg.com/736x/95/70/4e/95704ea6eb353dc3014d5f55a1f55250.jpg"));
	        dbProductos.add(new Producto(2, "A0001N", 37.5, 44.99, "vasija", "Vasija de estética china, perfecta para decorar.", 10, "Vasija china","http://www.museodevigo.org/img/coleccion/china.jpg"));
