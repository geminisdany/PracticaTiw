		...
		<div id="main-content">		
				...
				<div class="blank-space"></div>
					<div class="container-fluid" id="formularioRegistroC">
						<h1 id="registroC">Alta de datos de producto</h1>
						<p>Bienvenido a la p&aacute;gina de altas de datos de productos de Talaver&aacute;mica. Por favor, complete los siguientes campos.</p>
							...
							<div class="row">
							  <div class="form-group col-sm-5">
								...
								<input type="text" class="form-control" id="pre_min" name="pre_min"
									   placeholder="Precio m&iacute;nimo">&euro;
							  </div>
							  <div class="form-group col-sm-2"></div>
							  <div class="form-group col-sm-5">
								...
								<input type="text" class="form-control" id="pre_max" name="pre_max"
									   placeholder="Precio m&aacute;ximo">&euro;
							  </div>
							</div>
							<div class="row">
								<div class="form-group col-sm-12">
									<label for="descripcion">Descripci&oacute;n</label>
									<textarea rows="4" maxlength="255" class="form-control" id="descripcion" name="descripcion" placeholder="M&aacute;x. 255 caracteres"></textarea>
								</div>
							</div>
							<br>
							<div class="row">
							  ...
							  <div class="form-group col-sm-6">
								...
								<input type="text" class="form-control" id="urlImagen" name="urlImagen" placeholder="http://www.imagen.com/imagen.jsp"> 
							  </div>
							  <div class="form-group col-sm-3"></div>
							</div>
						  <br>
						  <div id="botones">
							<button type="submit" class="btn btn-default validadorForm" id="enviar">Guardar<span class="glyphicon glyphicon-ok"></span></button>
